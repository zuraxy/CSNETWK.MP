...
if __name__ == "__main__":
    ...
    print("2. Wait for peer discovery to complete")
    print("3. Use 'PROFILE' command to create/update your profile")
    print("4. Other peers will see your profile updates automatically")
    print("5. Avatar files should be under ~20KB for best performance")
    print("6. No central server needed - profiles broadcast to all discovered peers!")
